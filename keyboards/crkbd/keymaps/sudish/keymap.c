...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [U_BASE] = LAYOUT_wrapper(
    KC_ESC,  ___________________BASE_L1_________________,              ___________________BASE_R1_________________, TG_TAP,
    KC_CAPS, ___________________BASE_L2_________________,              ___________________BASE_R2_________________, KC_QUOT,
    TG_TAP,  ___________________BASE_L3_________________,              ___________________BASE_R3_________________, QK_BOOT,
