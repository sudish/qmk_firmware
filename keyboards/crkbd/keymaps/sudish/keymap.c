...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_wrapper(
    KC_ESC,  _________________QWERTY_L1_________________,              _________________QWERTY_R1_________________, TG_ADJS,
    KC_CAPS, _________________QWERTY_L2_________________,              _________________QWERTY_R2_________________, KC_QUOT,
    TG_SYS,  _________________QWERTY_L3_________________,              _________________QWERTY_R3_________________, TG_SYS,
  ...
  [_NUMBER_L] = LAYOUT_wrapper(
    ...
    _______, ________________NUMBER_L3__________________,              _______________HROW_R_NO___________________, _______,
    _______, ________________NUMBER_L3__________________,              ___________________KC_NO___________________, _______,
                                           __________________PASS_B6__________________
  ),
  ...
  [_NUMBER_R] = LAYOUT_wrapper(
    ...
    _______, ___________________KC_NO___________________,              ________________NUMBER_R3__________________, _______,
                                           __________________PASS_B6__________________
  ),
  ...
  [_SYMBOL_L] = LAYOUT_wrapper(
    ...
    _______, ________________SYMBOL_L3__________________,              ___________________KC_NO___________________, _______,
                                           __________________PASS_B6__________________
  ),
  ...
  [_SYMBOL_R] = LAYOUT_wrapper(
    ...
    _______, ___________________KC_NO___________________,              ________________SYMBOL_R3__________________, _______,
                                           __________________PASS_B6__________________
  ),

  [_SYSTEM] = LAYOUT_wrapper(
    RESET,   ________________SYSTEM_L1__________________,              ________________SYSTEM_R1__________________, TG_ADJS,
  ...
  [_GAME] = LAYOUT_wrapper(
    KC_T,    _________________GAME_L1___________________,              _________________GAME_R1___________________, TG_ADJS,
    KC_G,    _________________GAME_L2___________________,              _________________GAME_R2___________________, KC_NO,
    KC_B,    _________________GAME_L3___________________,              _________________GAME_R3___________________, TO_DEFL,
                                           _________________GAME_B6___________________
  ),

  [_GAMENF] = LAYOUT_wrapper(
    KC_TAB,  ________________GAMENF_L1__________________,              _________________GAME_R1___________________, TG_ADJS,
  ...
  [_GAMENAV] = LAYOUT_wrapper(
    KC_TAB,  ________________GAMENAV_R1_________________,              _________________GAME_R1___________________, TG_ADJS,
    KC_LSFT, ________________GAMENAV_R2_________________,              _________________GAME_R2___________________, KC_NO,
    KC_RCTL, ________________GAMENAV_R3_________________,              _________________GAME_R3___________________, TO_DEFL,
                                           _________________GAME_B6___________________
  ),

  [_ADJUST] = LAYOUT_wrapper(
    RESET,   ________________ADJUST_L1__________________,              ________________ADJUST_R1__________________, TG_ADJS,
