...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_wrapper( \
      ...
      TG_SYS,  _________________QWERTY_L3_________________, KC_LGUI, KC_RGUI, _________________QWERTY_R3_________________, TG_SYS,  \
  ...
  [_SYMBOL_L] = LAYOUT_wrapper( \
      TG_SYS,  ___________________PASS____________________,                   ___________________PASS____________________, _______, \
