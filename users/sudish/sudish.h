...
#define ________________SYMBOL_L1__________________              KC_UNDS,  KC_DOT,  KC_ASTR, KC_AMPR, KC_GRV
#define ________________SYMBOL_L2__________________              KC_MINS,  KC_LT,   KC_PERC, KC_GT,   KC_TILD
...
#define ________________SYSTEM_R2__________________       GCAS_R(MU_TOG ,  CK_TOGG, AU_ON,   AU_OFF,  AG_NORM)
